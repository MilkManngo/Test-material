...
int main()
{
    ...
    AnimatedSprite hero(10, "C:/Users/agama/Desktop/Szkola/Qt Projects/semester 2/build-platformer-Desktop_Qt_6_3_0_MinGW_64_bit-Debug/release/character.png");
    ...
    hero.add_animation_frame(sf::IntRect(160, 0, 30, 37));
    hero.add_animation_frame(sf::IntRect(210, 0, 30, 37));
    hero.add_animation_frame(sf::IntRect(260, 0, 30, 37));
    hero.add_animation_frame(sf::IntRect(310, 0, 30, 37));
    hero.add_animation_frame(sf::IntRect(360, 0, 30, 37));
    hero.add_animation_frame(sf::IntRect(410, 0, 30, 37));
    ...
    while (window.isOpen())
    {
        ...
        if(a == true)
        {
             hero.add_animation_frame(sf::IntRect(40, 0, -30, 37));
             hero.add_animation_frame(sf::IntRect(40, 0, -30, 37));
             hero.add_animation_frame(sf::IntRect(40, 0, -30, 37));
             hero.add_animation_frame(sf::IntRect(40, 0, -30, 37));
             hero.add_animation_frame(sf::IntRect(40, 0, -30, 37));
        ...
        {
            a = true;
            hero.add_animation_frame(sf::IntRect(190, 0, -30, 37));
            hero.add_animation_frame(sf::IntRect(240, 0, -30, 37));
            hero.add_animation_frame(sf::IntRect(290, 0, -30, 37));
            hero.add_animation_frame(sf::IntRect(340, 0, -30, 37));
            hero.add_animation_frame(sf::IntRect(390, 0, -30, 37));
            hero.add_animation_frame(sf::IntRect(440, 0, -30, 37));
        }
        else if(a == false)
        {
            hero.add_animation_frame(sf::IntRect(10, 0, 30, 37));
            hero.add_animation_frame(sf::IntRect(10, 0, 30, 37));
            hero.add_animation_frame(sf::IntRect(10, 0, 30, 37));
            hero.add_animation_frame(sf::IntRect(10, 0, 30, 37));
            hero.add_animation_frame(sf::IntRect(10, 0, 30, 37));
